...
import { progressLabelColor } from '../../progress/progressTheme';

/** Dark glass + white hairlines — matches progress / TextUI / list menus */
const useStyles = createStyles(() => ({
  ...
  sector: {
    fill: 'rgba(24, 24, 26, 0.97)',
    transition: 'fill 0.12s ease',

    '&:hover': {
      fill: 'rgba(52, 52, 58, 0.99)',
      cursor: 'pointer',
      '> g > text, > g > svg path': {
        fill: progressLabelColor,
      },
    },
    '> g > text': {
  ...
  centerCircle: {
    fill: 'rgba(14, 14, 16, 0.98)',
    stroke: 'rgba(255, 255, 255, 0.16)',
    strokeWidth: 2,
    transition: 'fill 0.12s ease, stroke 0.12s ease',
    '&:hover': {
      cursor: 'pointer',
      fill: 'rgba(28, 28, 32, 1)',
