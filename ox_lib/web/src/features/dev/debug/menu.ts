  ...
  debugData<MenuSettings>([
    {
      ...
      data: {
        ...
        titlePrefix: '||',
        bannerImage: 'https://placehold.co/384x100/1a1a1a/ffffff/png?text=Banner',
        items: [
          {
            label: 'Equipment',
            description: 'Access Police Equipment',
          },
          {
            label: 'Leave Equipment',
            description: 'Return standard loadout',
          },
